...
def register_partner(request):
    if request.method == 'POST':
        ...
        messages.success(request, '파트너 가입 신청이 완료되었습니다. 관리자 승인 후 이용하실 수 있습니다.')
        return redirect('portal:login')
...
def register_cs(request):
    if request.method == 'POST':
        ...
        messages.success(request, '고객센터 가입 신청이 완료되었습니다. Django 관리자 승인 후 이용하실 수 있습니다.')
        return redirect('portal:login')
